...
<Navbar/>
      ...
      <main className="flex-1">
          ...
          <div className="container relative px-4 md:px-6">
            ...
            >
              ...
              <h1 className="mb-6 text-4xl font-bold tracking-tight text-transparent md:text-5xl lg:text-6xl bg-clip-text bg-gradient-to-r from-foreground to-foreground/70">
                Your One Stop platform for Resolving your Queries!
              </h1>
              ...
              <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 lg:gap-16">
                {[1, 2, 3, 4, 5].map((i) => (
                  <Image
                    ...
                    width={120}
                    height={60}
                    className="w-auto h-8 transition-all opacity-70 grayscale hover:opacity-100 hover:grayscale-0"
                  />
                ))}
              </div>
            </div>
                ...
                <motion.div key={i} variants={item}>
                  <Card className="h-full overflow-hidden transition-all border-border/40 bg-gradient-to-b from-background to-muted/10 backdrop-blur hover:shadow-md">
                    <CardContent className="flex flex-col h-full p-6">
                      <div className="flex items-center justify-center mb-4 rounded-full size-10 bg-primary/10 dark:bg-primary/20 text-primary">
                        {feature.icon}
                      </div>
        ...
        <section className="relative w-full py-20 overflow-hidden md:py-32 bg-muted/30">
          ...
          <div className="container relative px-4 md:px-6">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="flex flex-col items-center justify-center mb-16 space-y-4 text-center"
            >
              <Badge className="rounded-full px-4 py-1.5 text-sm font-medium" variant="secondary">
                How It Works
              </Badge>
            ...
            <div className="relative grid gap-8 md:grid-cols-3 md:gap-12">
              ...
              {[
                ...
                >
                  <div className="flex items-center justify-center w-16 h-16 text-xl font-bold rounded-full shadow-lg bg-gradient-to-br from-primary to-primary/70 text-primary-foreground">
                    {step.step}
                  </div>
 ...
 <motion.div
    ...
    >
      <Link href="/aiagents">
        ...
        {/* Pricing Section */}
        <section id="pricing" className="relative w-full py-20 overflow-hidden md:py-32 bg-muted/30">
          <div className="absolute inset-0 -z-10 h-full w-full bg-white dark:bg-black bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,#1f1f1f_1px,transparent_1px),linear-gradient(to_bottom,#1f1f1f_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,#000_40%,transparent_100%)]"></div>
              ...
              <Tabs defaultValue="monthly" className="w-full">
                <div className="flex justify-center mb-8">
                  <TabsList className="p-1 rounded-full">
                    <TabsTrigger value="monthly" className="px-6 rounded-full">
                      Monthly
                    </TabsTrigger>
                    <TabsTrigger value="annually" className="px-6 rounded-full">
                      Annually (Save 20%)
                    </TabsTrigger>
                  </TabsList>
                </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <CardContent className="flex flex-col h-full p-6">
                            ...
                            <ul className="flex-grow my-6 space-y-3">
            ...
            <div className="max-w-3xl mx-auto">
              <Accordion type="single" collapsible className="w-full">
                {[
                  ...
                  >
                    <AccordionItem value={`item-${i}`} className="py-2 border-b border-border/40">
